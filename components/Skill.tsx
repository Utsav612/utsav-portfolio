  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        className="rounded-full border border-[#68B2A0] object-cover w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-20 lg:h-20 xl:w-20 xl:h-20 2xl:w-28 2xl:h-28 filter group-hover:grayscale transition duration-300 ease-in-out"
