...
export default function Projects({ projects }: Props) {
  return (
    ...
    >
      ...
      <div className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#2C6975]/80">
      ...
      <div className="w-full absolute top-[30%] bg-[#2C6975]/40 left-0 h-[350px] sm:h-[350px] md:h-[450px] -skew-y-12"></div>
    </motion.div>
  );
}
